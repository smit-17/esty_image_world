...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LEPDO Lifestyle — AI Jewelry Image Manager" },
      {
        name: "description",
        content:
          "Centralised library for LEPDO Lifestyle's AI-generated jewelry imagery — upload, organise and search every product.",
      },
      { name: "author", content: "LEPDO Lifestyle" },
